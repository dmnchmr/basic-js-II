...
switch (pet) { //se utiliza para evaluar la variable pet.
    case "perro": // case representa un valor posible de pet y la acción que se realizará si pet es igual a ese valor.
        console.log("Tengo un perro");
        break;
    case "gato":
        console.log("Tengo un gato");
    ...
    case "pájaro":
        console.log("Tengo un pájaro");
        break; //se utiliza para controlar el flujo de ejecución y salir de la estructura de control actual (switch en este caso).
    default:
        console.log("No tengo una mascota convencional");
}
...
if(typeof value === 'string') { //importante el typeof!!
...
for (let valor in programmers) { // se utiliza valor para acceder al elemento del array programmers en la posición correspondiente. programadores ahora contiene el objeto que representa a una programadora en la posición actual del bucle.
    let programadores = programmers[valor];
    ...
    ${programadores.knowledge}: Accede al conocimiento o aporte de la programadora en la posición actual. */
}
...
while (i <= 5) { // ejecutará mientras i sea menor o igual a 5.
    console.log(i);
    i++; // se utiliza para incrementar el valor de la variable
}
...
// saludar("Marta")
let saludoCompleto = saludar("María");
